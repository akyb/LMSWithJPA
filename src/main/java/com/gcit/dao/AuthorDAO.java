...
import com.gcit.repository.AuthorRepository;
...
public class AuthorDAO {
	...
	public void insert(Author author) throws SQLException {
		...
		// getConnection().prepareStatement("INSERT INTO `library`.`tbl_author`
	...
	// PreparedStatement prepareStatement =
	// getConnection().prepareStatement("UPDATE `library`.`tbl_author` SET
	...
	// PreparedStatement prepareStatement =
	// getConnection().prepareStatement("DELETE FROM `library`.`tbl_author`
	// WHERE `authorId`=?");
	...
	// PreparedStatement prepareStatement =
	// getConnection().prepareStatement("SELECT * FROM library.tbl_author where
	// authorId=?");
	// prepareStatement.setInt(1, authorId);
	...
	public List<Author> readAll() throws SQLException {
		// PreparedStatement prepareStatement =
		// getConnection().prepareStatement("SELECT * FROM library.tbl_author");
		// ResultSet resultSet = prepareStatement.executeQuery();
